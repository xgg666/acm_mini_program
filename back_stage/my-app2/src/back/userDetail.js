...
class ChangePic extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <img   onClick={this.showModal} className="btnpic" src={this.props.imageUrl} />
        <Modal
          title="Basic Modal"
      ...
      <div className="col-md-8 backgf">
        <div className="f-l">
          <div className="form-inline form" role="form"> 
            ...
            <Input value={this.state.username} className="form-control" placeholder="用户名" onChange={this.usernameChange} style={{height:30 , width:200}}/>
            </div> 
          </div>
          <div className="form-inline form" role="form"> 
            <div className="form-group"> 
          ...
          <div> 
            ...
            {this.state.auth==2?<Button type="primary">设为队员</Button>:null }
            &nbsp;
            {this.state.auth==3?<Button type="primary">设为管理员</Button>:null }
            &nbsp;
            {this.state.auth==4?<Button type="danger">取消管理员</Button>:null }
            &nbsp;
